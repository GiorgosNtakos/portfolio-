(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();var xe=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function ke(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var ce={exports:{}};(function(e,o){(function(t,a){e.exports=a()})(xe,function(){return function(t){function a(i){if(n[i])return n[i].exports;var l=n[i]={exports:{},id:i,loaded:!1};return t[i].call(l.exports,l,l.exports,a),l.loaded=!0,l.exports}var n={};return a.m=t,a.c=n,a.p="dist/",a(0)}([function(t,a,n){function i(d){return d&&d.__esModule?d:{default:d}}var l=Object.assign||function(d){for(var I=1;I<arguments.length;I++){var P=arguments[I];for(var B in P)Object.prototype.hasOwnProperty.call(P,B)&&(d[B]=P[B])}return d},b=n(1),S=(i(b),n(6)),c=i(S),h=n(7),u=i(h),p=n(8),m=i(p),y=n(9),E=i(y),$=n(10),W=i($),U=n(11),Y=i(U),X=n(14),J=i(X),L=[],Q=!1,v={offset:120,delay:0,easing:"ease",duration:400,disable:!1,once:!1,startEvent:"DOMContentLoaded",throttleDelay:99,debounceDelay:50,disableMutationObserver:!1},H=function(){var d=arguments.length>0&&arguments[0]!==void 0&&arguments[0];if(d&&(Q=!0),Q)return L=(0,Y.default)(L,v),(0,W.default)(L,v.once),L},G=function(){L=(0,J.default)(),H()},s=function(){L.forEach(function(d,I){d.node.removeAttribute("data-aos"),d.node.removeAttribute("data-aos-easing"),d.node.removeAttribute("data-aos-duration"),d.node.removeAttribute("data-aos-delay")})},r=function(d){return d===!0||d==="mobile"&&E.default.mobile()||d==="phone"&&E.default.phone()||d==="tablet"&&E.default.tablet()||typeof d=="function"&&d()===!0},f=function(d){v=l(v,d),L=(0,J.default)();var I=document.all&&!window.atob;return r(v.disable)||I?s():(v.disableMutationObserver||m.default.isSupported()||(console.info(`
    ...
    `}let ue=!1;function Ae(e){ue=e}function ee(e){!ue&&sessionStorage.getItem(`animated_${e}`)?setTimeout(()=>{document.querySelectorAll(`#${e} [data-aos]`).forEach(o=>{o.removeAttribute("data-aos"),o.removeAttribute("data-aos-delay")})},0):sessionStorage.setItem(`animated_${e}`,"1")}function me(){document.querySelectorAll("[data-skill-toggle]").forEach(e=>{e.addEventListener("click",()=>{const o=e.getAttribute("data-skill-toggle"),t=document.getElementById(o),a=e.querySelector("span:last-child"),n=t.classList.contains("hidden");t.classList.toggle("hidden"),a.textContent=n?"−":"+"})})}function Ie(e,o){return`
      <div>
    ...
    `}function Z(e,o,t=0){const a=e.toLowerCase().replace(/\s+/g,"-");return`
      <div class="flex flex-col h-full" data-aos="zoom-in-up" data-aos-delay="${t}">
        ...
        <div id="${a}" class="hidden pt-4 transition-all duration-300">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ${o.map(n=>Ie(n.name,n.percent)).join("")}
          </div>
        </div>
      </div>
    `}function pe(e="en",o){ee("about-section");const t=o[e].aboutSection;return`
      <section id="about-section" class="bg-slate-800 py-24 px-4 text-white">
        <div class="max-w-7xl mx-auto space-y-20">
          <div data-aos="fade-down">
            ${ae(t.title,"text-yellow-300","left")}
          </div>
          ...
          <div class="space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-x-12 gap-y-6 items-start">
              ${Z("HDL",[{name:"VHDL",percent:90},{name:"Verilog / SystemVerilog",percent:76}],0)}
              ${Z("Programming Languages",[{name:"C",percent:85},{name:"Java",percent:85},{name:"SQL",percent:75}],100)}
              ${Z("EDA Tools",[{name:"Synopsys Tools",percent:80},{name:"Vivado",percent:85},{name:"ModelSim",percent:80},{name:"Cadence",percent:73}],200)}
              ${Z("Software & OS",[{name:"Visual Studio",percent:80},{name:"Microchip Studio",percent:68},{name:"Linux OS",percent:77}],300)}
              ${Z("Others",[{name:"LATEX",percent:75},{name:"Git / Bash",percent:73},{name:"TCL Scripting",percent:62}],400)}
            </div>
          </div>
        </div>
      </section>
    `}const fe=(e,o)=>{ee("contact");const t=o[e].contactSection;return`
...
`};function oe(e,o,t,a){const n={email:{bg:"bg-cyan-500 hover:bg-cyan-400",icon:'<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>'},github:{bg:"bg-slate-800 hover:bg-slate-700",icon:'<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M12 0a12 12 0 00-3.79 23.4c.6.1.82-.26.82-.58v-2.23c-3.34.73-4.04-1.6-4.04-1.6-.55-1.38-1.34-1.74-1.34-1.74-1.1-.75.08-.74.08-.74 1.22.1 1.86 1.25 1.86 1.25 1.08 1.85 2.84 1.31 3.53 1 .1-.78.42-1.31.76-1.61-2.66-.3-5.47-1.34-5.47-5.96 0-1.32.47-2.4 1.24-3.24-.13-.3-.54-1.53.12-3.2 0 0 1-.32 3.3 1.23a11.5 11.5 0 016 0c2.3-1.55 3.3-1.23 3.3-1.23.66 1.67.25 2.9.12 3.2.77.84 1.24 1.92 1.24 3.24 0 4.63-2.82 5.65-5.5 5.95.44.37.82 1.1.82 2.22v3.29c0 .32.21.69.82.57A12 12 0 0012 0z" clip-rule="evenodd"/></svg>'},linkedin:{bg:"bg-cyan-500 hover:bg-cyan-400",icon:'<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-white" viewBox="0 0 448 512" fill="currentColor"><path d="M100.28 448H7.4V149.1h92.88zm-46.44-338C24.24 110 0 85.77 0 56.72A56.66 56.66 0 0 1 56.68 0c31.23 0 56.47 24.23 56.47 56.68 0 29.05-25.24 53.28-56.47 53.32zM447.92 448h-92.6V304.4c0-34.25-.71-78.21-47.65-78.21-47.66 0-54.95 37.26-54.95 75.7V448h-92.56V149.1h88.84v40.8h1.28c12.39-23.49 42.64-48.27 87.79-48.27 93.92 0 111.21 61.85 111.21 142.3V448z"/></svg>'}},{bg:i,icon:l}=n[a];return`
  ...
  `}const ge=(e,o)=>{manageAOS("home"),setTimeout(()=>startTypewriter(o[e].typewriter),500);const t=e==="gr"?"Γεώργιος Ντάκος":"Georgios Ntakos";return`
    <section id="home" class="min-h-screen flex flex-col items-center justify-center bg-cover bg-center text-white sm:text-left w-full"
      ...
      <div class="max-w-7xl w-full mx-auto px-4 py-12 space-y-8">
        <div data-aos="fade-down">
          ${SectionTitle(t,"text-cyan-400 text-shadow-neon","left")}
        </div>
  ...
  `};function he(e,o){ee("resume");const t=o[e];return`
    <section id="resume" 
      ...
      <div class="max-w-7xl w-full mx-auto" data-aos="fade-down" data-aos-delay="100">
        ${ae(t.resume,"text-cyan-300","left")}
      </div>
  ...
  `}function be(e,o){ee("projects");const t=o[e];return`
    <section id="projects" class="min-h-screen bg-slate-800 px-4 py-24">
      <div class="max-w-7xl mx-auto space-y-20">
        <div data-aos="fade-down" data-aos-delay="100">
          ${ae(t.projectsTitle,"text-yellow-300","left")}
        </div>
  ...
  `}function Te(e,o){const t=o[e];return`
    <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-x-[525px] gap-y-6 justify-items-center mt-12">
  ...
  `}function ye(e,o){const t=document.getElementById("tab-content"),a=(n,i)=>{document.getElementById(n).addEventListener("click",()=>{t.innerHTML=i(e,o),requestAnimationFrame(()=>ne.refresh()),document.querySelectorAll(".tab-button").forEach(l=>l.classList.replace("text-yellow-300","text-cyan-400")),document.getElementById(n).classList.replace("text-cyan-400","text-yellow-300")})};a("projects-tab",Te),a("work-tab",se),a("conferences-tab",Ee),t.innerHTML=se(e,o),requestAnimationFrame(()=>ne.refresh()),document.getElementById("work-tab").classList.replace("text-cyan-400","text-yellow-300")}function ve(e,o){var a;ee("timeline");const t=(a=o[e])==null?void 0:a.timelineEvents;return Array.isArray(t)?`
    <section id="timeline" class="min-h-screen bg-slate-900 py-24 px-4">
      <div class="max-w-screen-xl mx-auto">
        <div data-aos="fade-down" data-aos-delay="100">
          ${ae(o[e].timeline,"text-cyan-400","left")}
        </div>
        <div class="space-y-16 relative mt-12">
          ...
          ${t.map((n,i)=>$e(n,i)).join("")}
        </div>
      </div>
    </section>
  `:(console.error("❌ timelineEvents not found or not an array"),"<section id='timeline'></section>")}function $e({year:e,title:o,description:t,side:a},n){const i=a==="left",l=i?"fade-right":"fade-left",b=n*100;return`
  ...
  `}function de(){return'<div class="w-1/2"></div>'}function Le(){return`
...
I also networked with experts in AI and embedded systems.`}],projectsList:[{title:"Diploma Thesis: Hummingbird-2 on FPGA",tech:["VHDL","ModelSim","Vivado","FPGA"],description:"An embedded cryptographic module was developed that implements the Hummingbird-2 algorithm and targets low-resource environments, such as RFID and wireless sensors. The maximum frequency achieved on the Artix-7 FPGA was 244 MHz while optimizing for area and power.",extended:"The project involved simulation, synthesis, and gate-level hardware implementation using ModelSim and Vivado. Architectural enhancements such as pipelining and parallelization were explored, resulting in significant throughput gains. A complete authenticated encryption system with verified correctness and efficient area/power trade-offs was delivered. A comparison against lightweight ciphers in the literature showed competitive performance."},{title:"MySynth: Music Note Synthesizer with VGA Output",tech:["Verilog","ModelSim","Xilnix ISE","FPGA"],description:`A digital music synthesizer system was developed on an FPGA that enables users to play musical notes using a PS/2 keyboard.
  ...
  `}function we(e){const o=k[e];document.getElementById("nav-home").innerText=o.home,document.getElementById("nav-about").innerText=o.about,document.getElementById("nav-resume").innerText=o.resume,document.getElementById("nav-work").innerText=o.work,document.getElementById("nav-timeline").innerText=o.timeline,document.getElementById("nav-contact").innerText=o.contact,document.getElementById("nav-lang").innerText=o.langToggle}function Me(e){we(e),document.getElementById("home").outerHTML=ge(e,k),document.getElementById("about-section").outerHTML=pe(e,k),document.getElementById("resume").outerHTML=he(e,k),document.getElementById("projects").outerHTML=be(e,k),document.getElementById("timeline").outerHTML=ve(e,k),document.getElementById("contact").outerHTML=fe(e,k),ye(e,k),me(),setTimeout(()=>{document.querySelectorAll(".read-more-btn").forEach(o=>{var n;const t=o.getAttribute("data-target"),a=(n=document.getElementById(`more-${t}`))==null?void 0:n.classList.contains("hidden");o.textContent=a?k[e].readMore:k[e].readLess}),ne.init({duration:600,easing:"ease-out-cubic",once:!0})},100),window.scrollTo({top:0,behavior:"smooth"})}je(z);we(z);ye(z,k);me();window.addEventListener("load",()=>{window.location.hash&&history.replaceState(null,null," "),setTimeout(()=>{var e;(e=document.getElementById("home"))==null||e.scrollIntoView({behavior:"auto"}),ne.init({duration:600,easing:"ease-out-cubic",once:!0})},100)});window.addEventListener("beforeunload",()=>{sessionStorage.clear()});document.addEventListener("DOMContentLoaded",()=>{document.getElementById("lang-toggle").addEventListener("click",()=>{z=z==="en"?"gr":"en",localStorage.setItem("lang",z),Ae(!0),Me(z)});const e=document.querySelectorAll(".tab-button");e.forEach(o=>{o.addEventListener("click",()=>{e.forEach(t=>t.classList.replace("text-yellow-300","text-cyan-400")),o.classList.replace("text-cyan-400","text-yellow-300")})})});document.addEventListener("click",e=>{if(e.target.classList.contains("read-more-btn")){const o=e.target.getAttribute("data-target"),a=document.getElementById(`more-${o}`).classList.toggle("hidden");e.target.textContent=a?k[z].readMore:k[z].readLess}});document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("sidebar"),o=document.getElementById("sidebar-toggle"),t=document.getElementById("sidebar-close");o&&e&&o.addEventListener("click",()=>{e.classList.remove("-translate-x-full")}),t&&e&&t.addEventListener("click",()=>{e.classList.add("-translate-x-full")}),document.querySelectorAll(".nav-icon a").forEach(a=>{a.addEventListener("click",()=>{window.innerWidth<640&&e.classList.add("-translate-x-full")})})});
